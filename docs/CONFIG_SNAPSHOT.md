...
- **Traces (bevegelseslinjer):** enabled overall, description "Viser bevegelseslinjer…"
  - Player traces: opacity `0.7`, style `dashedStraight` *(legacy alias: `dashedStraightArrow`)*
  - Opponent traces: opacity `0.7`, style `dashedStraight` *(faller tilbake til player-stil ved manglende felt)*
...
- **PNG:** scale `2`, background `#ffffff`
- **GIF:** frameDuration `600ms`, quality `10`
- **MP4:** frameDuration `600ms`
